  ...
  return (
    <main className="bg-neutral-900 text-neutral-200 flex flex-col ">
      ...
      <div className="grid grid-cols-2 gap-4 mb-10 px-4 w-full max-w-[300px] mx-auto">
        <Link href="/portfolio" className="bg-black p-2 w-full aspect-square rounded-lg flex flex-col items-center justify-center text-center border border-white/10 shadow-[0_0_15px_rgba(255,255,255,0.1)] transition-transform hover:scale-105">
